...
import { getHighlighter, type HighlighterGeneric, type BundledLanguage, type BundledTheme } from '~/utils/shiki-loader';

let shellHighlighter: HighlighterGeneric<BundledLanguage, BundledTheme> | null = null;

async function getShellHighlighter() {
  if (!shellHighlighter) {
    shellHighlighter = await getHighlighter();
  }
...
function ShellCodeBlock({ classsName, code }: ShellCodeBlockProps) {
  ...
  useEffect(() => {
    const highlight = async () => {
      const highlighter = await getShellHighlighter();
