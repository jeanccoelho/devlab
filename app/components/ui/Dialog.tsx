...
export const Dialog = memo(({ className, children, onBackdrop, onClose, isOpen, title }: DialogProps) => {
  return (
    <RadixDialog.Root open={isOpen} onOpenChange={(open) => !open && onClose?.({} as React.UIEvent)}>
      <RadixDialog.Portal>
